class UI{
    ...
    create_footer(){
        document.getElementById("footer").innerHTML = `
            ...
            <p class="blockquote-footer text-center text-muted">Efe Furkan KARAKAYA ve Yusuf Kerem ÇALIKOĞLU tarafından geliştirilmiştir. | Veriler <a href="https://github.com/novelcovid/api" style="color: #FFFF99;" target="_blank">novelcovidapi</a>'dan sağlanmaktadır. | © 2020<br>
            Resmi verilere aynı zamanda T.C. Sağlık Bakanlığı'nın <a href="https://covid19.saglik.gov.tr/" target="_blank">sitesinden</a> de ulaşabilirsiniz.</p>
